...
from core.lorawan_cipher import lorawan_aes128_cmac
from core.lorawan_cipher import lorawan_aes128_encrypt
from core.lorawan_cipher import lorawan_frmp_encryption
from core.lorawan_cipher import lorawan_frmp_integrity
# NOTE:
...
## Possible frame format
    ...
    if fport_i == 0:
        ...
        if nwkskey is not None:
            ...
            # print_w("无法解密MAC Command,因为没有Nwkskey.")
        #
        return ret_o
    else:
        # case 1,4
        ...
        if appskey is not None:
            ...
            # print_w("无法解析应用数据，因为没有输入正确的AppSKey.")
        #
        return ret_o
